...
const About = () => {
  return (
    ...
    <motion.div initial={{opacity:0}} whileInView={{opacity:1,transition:{delay:0.5, ease:'linear', duration:0.8}}} viewport={{ once: true }}  className='w-[90%] extralarge:w-[80%] xxsmall:w-[70%]   large:w-[95%] flex flex-col gap-10  font-ppt'>
      <div className=' medium:flex-col  flex justify-between items-center  hover:rounded-2xl extralarge:gap-20  '>
          <img className=' xextrasmall:w-[600px] hover:scale-105 transition-transform  hover:blur-[2px] w-[600px] rounded-2xl hover:ease-in hover:duration-300 ' src={about} alt="" />
          <div className='flex flex-col gap-7 w-[500px] medium:w-[700px] xxsmall:px-10 xxsmall:w-[480px] extrasmall:w-[400px]  '>
      ...
      <div className='flex mt-10  justify-between xxxsmall:px-10 xsmall:px-20 small:px-32 medium:px-48 xxsmall:px-20  extralarge:gap-16 medium:flex-col-reverse '>
          <div className='flex flex-col gap-5 w-[300px] medium:w-[500px] medium:-mx-10 xxsmall:w-[400px] extrasmall:w-[300px] '>
              ...
              <button className='bg-yellow-300 mx-20 my-4 py-3 rounded-2xl w-[200px] xextrasmall:mx-0 '><NavLink onClick={()=>{(window.scrollTo({top:0,behavior:'smooth'}))}} to='/about' >Know More About Us</NavLink></button>
          </div>
          <div className='  flex flex-col gap-5 w-[300px] medium:w-[500px] medium:-mx-10 xxsmall:w-[400px] extrasmall:w-[300px] '>
          ...
          <div className='hover:overflow-hidden hover:rounded-2xl xextrasmall:w-[300px] xextrasmall:-ml-12 '>
          <img className=' xxsmall:w-[400px]  w-[500px]  h-[300px] rounded-2xl  hover:scale-105 transition-transform  hover:blur-[2px] hover:ease-in hover:duration-300  ' src={about2} alt="" />
          </div>
      </div>
    </motion.div>
  </div>
