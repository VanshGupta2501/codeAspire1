...
const Hero = () => {
  return (
    <div data-scroll data-scroll-speed="-0.9" className=' xxsmall:my-16 xxxsmall:my-6 hero w-full h-screen flex justify-center items-center my-4 text-gray-400 bg-black ' >
