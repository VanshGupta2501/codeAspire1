  ...
  return (
    <div className='    large:-mt-4  small:h-[1400px] large:h-[1350px] extralarge:mt-[50px] extralarge:h-[800px] product rounded-3xl w-full h-[700px]  flex justify-center items-center text-black xextralarge:mt-10 '>
      <div  className='  xsmall:px-2   large:flex-col w-[100%] h-[96%] bg-[#DED0B6] xsmall:w-[800px] flex items-center gap-3 px-10 xextralarge:gap-20    xextralarge:px-40 '>
        <div className=' border border-black xxxsmall:w-[400px] xxxsmall:mr-2 small:w-[600px] flex flex-col large:w-full large:-my-20 large:mt-7 gap-2 border-r-3 py-28 pl-8 extralarge:gap-5 xsmall:w-[600px] '>
          <h1 className=' text-4xl text-blue-400 font-bold large:text-5xl  xextralarge:text-6xl extralarge:text-5xl'>Products</h1>
          <h1 className=' text-5xl  large:text-7xl xxxsmall:-mt-4 font-extrabold leading-tight tracking-tight xextralarge:text-6xl small:text-7xl extralarge:text-5xl xxxsmall:text-5xl xxsmall:text-4xl '>We Provide the Best Quality Products </h1>
          <p className=' text-lg font-medium large:text-2xl xextralarge:text-4xl extralarge:text-3xl xxsmall:text-2xl xxxsmall:w-[400px] border  '>We are technology solutions providing company all over the world.</p>
        </div>
      <Swiper
    ...
    className=' w-[90%] border extralarge:w-[70%] extralarge:h-[80%] xextralarge:w-[55%] xextralarge:h-[80%]   h-[500px] small:w-[100%] large:h-[45%] large:w-[80%] xsmall:w-[550px] xsmall:-ml-2 xxxsmall:w-[60%] ' style={{
