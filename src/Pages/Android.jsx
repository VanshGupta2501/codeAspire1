...
const Android = () => {
  return (
<>
    <div className='w-full h-[3100px]  flex justify-center items-center mt-10 font-ppt bg-[#fcf8ea] '>
        <div className='w-[90%] h-[90%]  flex flex-col items-center justify-start gap-3 '>
            <div className='flex justify-center items-center flex-col gap-10' >
            <h1 className='text-7xl font-semibold  ' >App Development</h1>
            ...
            <img className='rounded-2xl hover:scale-110 hover:blur-[1px]  hover:duration-300 transition-transform ' src="https://www.code-aspire.com/images/services-details/services-details-1.jpg " alt="" />
            </div>
            </div>
           ...
           <div className='w-[95%] flex flex-col justify-center item-center '>
                <div className='  grid grid-cols-3 gap-24 pt-16 px-10'>
