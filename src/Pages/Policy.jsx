  ...
  return (
    ...
    <div className='w-full flex justify-center items-center mt-32 mb-2 py-10 bg-[#fcf8ea] shadow-xl '>
      <div className='  flex justify-center  items-center gap-10  flex-col font-ppt' >
        <div className='w-[90%]  extralarge:w-[1000px]  large:w-[800px] medium:w-[600px] small:w-[500px] xxsmall:w-[300px] flex justify-center items-center  rounded-2xl  hover:overflow-hidden  ' >
        <img className=' rounded-2xl  hover:scale-110  hover:duration-300  hover:blur-[1px]  hover:transition-transform ' src="https://www.code-aspire.com/images/terms-of-service.jpg" alt="" />
        </div>
        <h1 className='text-xl xextralarge:text-3xl font-bold' >Privacy Policy</h1>
        <p className='text-lg xextralarge:text-xl font-ppt'>Our website address is: https://code-aspire.com</p>

        <div className='flex flex-col w-[70%] gap-4 rounded-2xl bg-blue-200 px-3 py-3' >
