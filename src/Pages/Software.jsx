...
const Software = () => {
  return (
    ...
    <div className='w-full h-[3100px] extrasmall:h-[4900px] extralarge:h-[3200px] xextralarge:h-[3500px] xsmall:h-[3600px] xxsmall:h-[4700px]  flex justify-center items-center my-20 font-ppt bg-[#fcf8ea] '>
        <div className='w-[90%] h-[90%]   flex flex-col items-center justify-center gap-3 '>
            <div className='flex justify-center items-center flex-col gap-10' >
            <h1 className='text-7xl font-semibold medium:text-6xl  extrasmall:text-4xl ' >Software Development</h1>
