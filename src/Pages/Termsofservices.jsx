    ...
    <Navbar/>
      <div className='w-full xextrasmall:h-[3650px]  h-[2500px] medium:h-[2800px] xsmall:h-[2900px] xxsmall:h-[3000px] xxxsmall:h-[3100px] extrasmall:h-[3500px] flex items-center justify-center font-ppt '>
        <div className='w-[80%] xxxsmall:w-[90%] xxxsmall:h-[95%] h-[90%] flex items-center justify-center flex-col gap-16 bg-[#fcf8ea]  '>
          ...
          <h1 className='extralarge:text-2xl font-bold xextralarge:text-3xl ' >1. Our Website</h1>
          <p className='extralarge:text-lg extralarge:font-medium xextralarge:text-2xl xextralarge:font-semibold   '>Our website address is: https://code-aspire.com</p>
          <h1 className='bg-green-200 px-2 py-3 extralarge:text-lg xextralarge:text-xl  rounded-3xl' >We collect certain data from you directly, like information you enter yourself, data about your participation in courses, and data from third-party platforms you connect with Stax. We also collect some data automatically, like information about your device and what parts of our Services you interact with or spend time using.</h1>
        </div>

        <div className='flex justify-center items-start flex-col gap-4' >
          <h1 className='extralarge:text-2xl font-bold xextralarge:text-3xl ' >2. Data You Provide to Us</h1>
          <h1 className='bg-green-200 px-2 py-3 extralarge:text-lg xextralarge:text-xl rounded-3xl' >We may collect different data from or about you depending on how you use the Services. Below are some examples to help you better understand the data we collect.</h1>
        </div>

        <div className='flex justify-center items-start flex-col gap-4' >
          <h1 className='extralarge:text-2xl font-bold xextralarge:text-3xl ' >3. How We Get Data About You</h1>
          <h1 className='bg-green-200 px-2 py-3 extralarge:text-lg xextralarge:text-xl  rounded-3xl' >We use tools like cookies, web beacons, analytics services, and advertising providers to gather the data listed above. Some of these tools offer you the ability to opt out of data collection.</h1>
        </div>

        <div className='flex justify-center items-start flex-col gap-4' >
          <h1 className='extralarge:text-2xl font-bold xextralarge:text-3xl ' >4. What We Use Your Data For</h1>
          <ul className='bg-green-200 px-7 py-3 extralarge:text-lg xextralarge:text-xl  rounded-3xl flex flex-col gap-3' >
        ...
        <div className='flex justify-center items-start flex-col gap-4' >
          <h1 className='extralarge:text-2xl font-bold xextralarge:text-3xl ' >5. Your Choices About the Use of Your Data</h1>
          ...
          <ol className='bg-green-200 px-7 py-3 extralarge:text-lg xextralarge:text-xl  rounded-3xl flex flex-col gap-3' >
        ...
        <div className='flex justify-center items-start flex-col gap-4' >
          <h1 className='extralarge:text-2xl font-bold xextralarge:text-3xl ' >6. Our Policy Concerning Children</h1>
          <h1 className='bg-green-200 px-2 py-3 extralarge:text-lg xextralarge:text-xl  rounded-3xl' >We recognize the privacy interests of children and encourage parents and guardians to take an active role in their children's online activities and interests. Children under 13 (or under 16 in the European Economic Area) should not use the Services. If we learn that we've collected personal data from a child under those ages</h1>
        </div>
          </div>
        </div>
    </div>
