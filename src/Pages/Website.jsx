...
const Website = () => {
  return (
    ...
    <div className='w-full h-[3100px] extralarge:h-[3200px] xsmall:h-[5000px]  flex justify-center items-center mt-10 font-ppt bg-[#fcf8ea] '>
        <div className='w-[90%] h-[90%]   flex flex-col items-center justify-start gap-3 '>
            <div className='flex justify-center items-center flex-col gap-10' >
            <h1 className='text-7xl font-semibold  ' >Website Development</h1>
           ...
           <div className='w-[95%] flex flex-col justify-center item-center '>
                <div className='  grid large:grid-cols-2 xxsmall:grid-cols-1 grid-cols-3 gap-10 pt-16 px-10'>
